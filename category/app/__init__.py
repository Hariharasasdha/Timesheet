...
rest_api = Api(
    title="Category Configuration API",
    doc="/category_config/api-docs",
    authorizations=authorization_api_doc,
    security='api_key',
    base_url="/category_config",
    url_scheme="http"
)
ipss_db = IpssDb()
...
def create_app(config):
    ...
    with app.app_context():
        ...
        from .api.category import category_config_api_route
        rest_api.add_namespace(category_config_api_route)  # sku_match_api_route
