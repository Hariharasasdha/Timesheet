...
def create_app(config):
    ...
    with app.app_context():
        ...
        from .api.project import project_api_route
        rest_api.add_namespace(project_api_route)  # sku_match_api_route
        from .api.project import activity_api_route
        rest_api.add_namespace(activity_api_route)
